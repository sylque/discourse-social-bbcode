      ...
      replace: function(state, tagInfo, content) {
        ...
        */
        ...
        token.content = `
          ...
          <script async defer crossorigin="anonymous" src="https://connect.facebook.net/fr_FR/sdk.js#xfbml=1&version=v5.0&appId=${tagInfo.attrs.appId}&autoLogAppEvents=1"></script>
          <span class="fb-like" ${params}>Facebook Button(s)</span>
        `
        token = state.push("span_close", "span", -1)
        return true
      }
